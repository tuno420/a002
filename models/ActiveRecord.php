...
class ActiveRecord
{
    ...
    // Obtener imagenes de lote
    public static function findByBatchId($batch_id)
    {
        $query = "SELECT * FROM " . static::$tabla . " WHERE batch_id = ${batch_id}";
        $resultado = self::consultarSQL($query);
    ...
    // Obtener imagenes de categoria
    public static function findByCatId($cat_id)
    {
        $query = "SELECT * FROM " . static::$tabla . " WHERE cat_id = ${cat_id}";
        $resultado = self::consultarSQL($query);
    ...
    // Obtener videos de categoria
    public static function findVideosByCatId($cat_id)
    {
        $query = "SELECT * FROM " . static::$tabla . " WHERE cat_id = ${cat_id}";
        $resultado = self::consultarSQL($query);
    ...
    // Obtener btags de categoria
    public static function findBtagsByCatId($cat_id)
    {
        $query = "SELECT * FROM " . static::$tabla . " WHERE cat_id = ${cat_id}";
        $resultado = self::consultarSQL($query);

        $btags = array();
        foreach ($resultado as $btag) {
            $btags[] = new Btag($btag);
        }
        return $btags;
    }
    ...
    public static function where3($columna, $valor)
    {
